    ...
    <section className="max-w-5xl mx-auto px-6 py-24 space-y-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
        {team.map((member, idx) => (
          <div
            key={idx}
            className="bg-gradient-to-br from-black via-gray-900 to-neutral-800 rounded-2xl border border-neutral-700 p-6 text-center transition hover:scale-[1.02] hover:border-purple-600 duration-300"
          >
            <img
              src={member.photo}
              alt={member.name}
